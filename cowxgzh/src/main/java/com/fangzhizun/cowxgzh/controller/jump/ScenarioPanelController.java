...
@Controller
public class ScenarioPanelController {
    /*页面跳转 传输参数*/
    @RequestMapping( "givScenarioPanel")
    public String giveYouCurtainsParameter(HttpServletRequest request, Model model) throws ParseException, IOException {
